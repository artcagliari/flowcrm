...
export default function ResourcePage({ title, subtitle, api, fields, columns, defaults = {}, modalTitle, createLabel = 'Novo', filters = [], sortOptions = [], transformSubmit, prepareEdit, extraActions, validateForm }) {
  ...
  async function submit(e) {
    e.preventDefault();
    if (validateForm && !validateForm(form)) return;
